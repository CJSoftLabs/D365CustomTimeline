...
export class SearchPanel extends React.Component<SearchProps, SearchProps>{
                    ...
                    <Stack>
                        ...
                        {this.state.SelectedDuration === 'custom' &&
                            (<Stack horizontalAlign='center'>
                                <DateRangePicker StartDate={ this.state.DateRange.StartDate } EndDate={ this.state.DateRange.EndDate } UpdateDateFields={ this.UpdateCustomDates }></DateRangePicker>
                            </Stack>
                            )
                        }
                    </Stack>
    ...
    onDurationChange (ev?: React.FormEvent<HTMLElement | HTMLInputElement>, option?: IChoiceGroupOption) {
        ...
        if(value !== 'custom') {
            ...
            this.setState({ DateRange: { StartDate: sDate, EndDate: new Date(), UseCalendarMonth: this.state.DateRange.UseCalendarMonth } });
        }
    }
    ...
    UpdateCustomDates(StartDate: Date, EndDate: Date): void {
        this.setState({ DateRange: { StartDate: StartDate, EndDate: EndDate, UseCalendarMonth: this.state.DateRange.UseCalendarMonth } });
    }
